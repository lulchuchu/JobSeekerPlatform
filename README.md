...
Social media platform helps user communicate and find desirale experience.
...
Users can follow others users and look at theirs experience experience, post created, currently working
company, ....<br/>
...
The manager of a company can manage opening experience of that company, and manage applicant: set interview time for
applicants or reject applicants, when done, applicant will receive notification of result<br/>
## Detail:
...
This is openning experience page, on the left side displays short info about the experience, the right side about
experience details will show up if user clicked to a experience on the left<br/>
There is a apply button for user to apply to the experience<br/>
If user is a manager of a company, there will be View applicants button, manager can click to that button to display all
applicant applied to that experience<br/>
There is a buttong list on top to filter suitable experience for user.<br/>
### Company page
...
This page will display all opening experience of a company in table, click a row to display all applicant applied<br/>
![image](https://github.com/lulchuchu/JobSeekerPlatform/assets/31687664/66af5f3f-a792-456d-86c6-49ad4947b247)
This page will display all user applied for a experience, there is a choose button to set interview and reject buttong
to reject applicant<br/>
